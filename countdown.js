...
const SoundIcon = () => /*#__PURE__*/React.createElement("svg", {
  ...
  strokeWidth: 2,
  d: "M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.707.707L5.586 15z"
}));
const MutedIcon = () => /*#__PURE__*/React.createElement("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  className: "h-6 w-6 text-gray-500 group-hover:text-cyan-400 transition-colors duration-150",
  fill: "none",
  viewBox: "0 0 24 24",
  stroke: "currentColor"
}, /*#__PURE__*/React.createElement("path", {
...
const DigitCard = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: `${innerDivClasses} w-full h-full flex items-center justify-center`
  }, digit));
};
const FlipUnit = ({
  digit,
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "relative w-8 h-14 sm:w-10 sm:h-16 md:w-12 md:h-20 lg:w-14 lg:h-24 perspective-1000 shadow-lg shadow-black/60 rounded-lg overflow-hidden"
  }, /*#__PURE__*/React.createElement("div", {
    className: "absolute top-0 left-0 w-full h-full bg-[linear-gradient(165deg,rgba(255,255,255,0.2)_0%,rgba(255,255,255,0)_20%)] z-30 pointer-events-none"
  }), /*#__PURE__*/React.createElement("div", {
    ...
    className: "absolute top-1/2 -mt-px w-full h-px bg-black/50 z-20"
  }), /*#__PURE__*/React.createElement("div", {
    className: `absolute top-0 left-0 w-full h-1/2 origin-bottom transition-transform duration-500 ease-[cubic-bezier(0.45,0,0.55,1)] transform-style-preserve-3d ${isFlipping ? '[transform:rotateX(-180deg)]' : ''}`
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "absolute inset-0 [transform:rotateX(180deg)] backface-hidden"
  }, /*#__PURE__*/React.createElement(DigitCard, {
    digit: currentDigit,
    position: "bottom"
  }))));
...
const Separator = () => /*#__PURE__*/React.createElement("div", {
  ...
  className: "w-1 h-1 md:w-2 md:h-2 rounded-full bg-zinc-800 ring-1 ring-inset ring-zinc-700"
}), /*#__PURE__*/React.createElement("div", {
  className: "w-1 h-1 md:w-2 md:h-2 rounded-full bg-zinc-800 ring-1 ring-inset ring-zinc-700"
}));
const FlipClock = ({
  ...
  }, /*#__PURE__*/React.createElement(FlipUnit, {
    digit: daysStr[0],
...
const DateDisplay = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "mt-2 text-center text-gray-600 text-xs md:text-sm"
  }, dateString);
};
...
const App = () => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onClick: () => {
      const el = document.querySelector('.event-exclusive');
      el.scrollIntoView({
        behavior: 'smooth'
      });
    }
  }, /*#__PURE__*/React.createElement("h3", {
    className: "text-lg md:text-xl font-semibold mb-2 text-gray-800"
  }, "Countdown to Webinar"), /*#__PURE__*/React.createElement(FlipClock, {
    days: days,
    hours: hours,
    minutes: minutes,
    seconds: seconds,
  ...
  }), /*#__PURE__*/React.createElement(DateDisplay, {
    date: targetDate
  }));
};
